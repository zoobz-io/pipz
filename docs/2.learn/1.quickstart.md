...
2. Check the [Cookbook](../4.cookbook/1.building-pipelines.md) for real-world recipes
3. Browse the [API Reference](../5.reference/1.cheatsheet.md) for detailed documentation
